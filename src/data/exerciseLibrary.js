...
export const defaultExercises = [
  { id: 'ab-wheel',              name: 'Ab Wheel Rollout',       category: 'Core',    muscleGroup: 'Abs',         prType: 'reps', isCustom: false },
  ...
  { id: 'bicycle-crunch',        name: 'Bicycle Crunch',         category: 'Core',    muscleGroup: 'Abs',         prType: 'reps', isCustom: false },
  { id: 'box-jump',              name: 'Box Jump',               category: 'Legs',    muscleGroup: 'Calves',      prType: 'reps', isCustom: false },
  { id: 'bulgarian-split-squat', name: 'Bulgarian Split Squat',  category: 'Legs',    muscleGroup: 'Glutes',      isCustom: false },
  { id: 'burpees',               name: 'Burpees',                category: 'Core',    muscleGroup: 'Full Body',   prType: 'reps', isCustom: false },
  ...
  { id: 'crunch',                name: 'Crunch',                 category: 'Core',    muscleGroup: 'Abs',         prType: 'reps', isCustom: false },
  { id: 'cycling',               name: 'Cycling',                category: 'Cardio',  muscleGroup: 'Full Body',   cardioUnit: 'distance', isCustom: false },
  { id: 'dead-bug',              name: 'Dead Bug',               category: 'Core',    muscleGroup: 'Abs',         prType: 'reps', isCustom: false },
  ...
  { id: 'elliptical',            name: 'Elliptical',             category: 'Cardio',  muscleGroup: 'Full Body',   cardioUnit: 'both',     difficultyLabel: 'resistance', isCustom: false },
  { id: 'face-pull',             name: 'Face Pull',              category: 'Pull',    muscleGroup: 'Rear Delts',  isCustom: false },
  { id: 'farmers-carry',         name: "Farmer's Carry",         category: 'Pull',    muscleGroup: 'Forearms',    isTimed: true, isCustom: false },
  ...
  { id: 'hollow-body',           name: 'Hollow Body Hold',       category: 'Core',    muscleGroup: 'Abs',         isTimed: true, isCustom: false },
  ...
  { id: 'jump-squat',            name: 'Jump Squat',             category: 'Legs',    muscleGroup: 'Quads',       prType: 'reps', isCustom: false },
  { id: 'kettlebell-swing',      name: 'Kettlebell Swing',       category: 'Pull',    muscleGroup: 'Full Body',   isCustom: false },
  ...
  { id: 'mountain-climber',      name: 'Mountain Climbers',      category: 'Core',    muscleGroup: 'Abs',         isTimed: true, isCustom: false },
  { id: 'neck-stretch',          name: 'Neck Stretch',           category: 'Stretch', muscleGroup: 'Flexibility', isCustom: false },
  { id: 'nordic-curl',           name: 'Nordic Curl',            category: 'Legs',    muscleGroup: 'Hamstrings',  prType: 'reps', isCustom: false },
  ...
  { id: 'plank',                 name: 'Plank',                  category: 'Core',    muscleGroup: 'Abs',         isTimed: true, isCustom: false },
  ...
  { id: 'rowing-machine',        name: 'Rowing Machine',         category: 'Cardio',  muscleGroup: 'Full Body',   cardioUnit: 'both',     isCustom: false },
  ...
  { id: 'side-plank',            name: 'Side Plank',             category: 'Core',    muscleGroup: 'Obliques',    isTimed: true, isCustom: false },
  ...
  { id: 'stair-climber',         name: 'Stair Climber',          category: 'Cardio',  muscleGroup: 'Full Body',   cardioUnit: 'time',     difficultyLabel: 'level',      isCustom: false },
  { id: 'bike',                  name: 'Stationary Bike',        category: 'Cardio',  muscleGroup: 'Full Body',   cardioUnit: 'distance', difficultyLabel: 'resistance', isCustom: false },
  ...
  { id: 'treadmill',             name: 'Treadmill',              category: 'Cardio',  muscleGroup: 'Full Body',   cardioUnit: 'both',     difficultyLabel: 'incline', difficultyDecimal: true, isCustom: false },
  ...
  { id: 'v-up',                  name: 'V-Up',                   category: 'Core',    muscleGroup: 'Abs',         prType: 'reps', isCustom: false },
